...
import argparse, time, threading, collections
...
parser.add_argument("--alert-up", type=float, default=5.0)
...
class PupilCoreClient:
    ...
    def close(self):
        self.stop_receiver(); self.sub.close(0); self.pub.close(0); self.req.close(0)
...
def main():
    ...
    metrics_text = ax.text(0.98, 0.05, "", transform=ax.transAxes,
